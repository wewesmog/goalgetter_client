...
- ALWAYS include user_id parameter in ALL tool calls
- The user_id will be provided in the TOOL CONTEXT section - use it for all database operations
- For goals/habits: Always include user_id parameter from TOOL CONTEXT
